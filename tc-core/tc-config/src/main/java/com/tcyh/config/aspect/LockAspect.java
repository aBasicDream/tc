package com.tcyh.config.aspect;

import com.tcyh.config.annotation.Key;
import com.tcyh.config.annotation.Lock;
...
public class LockAspect {
    ...
    @Around(value = "@annotation(com.tcyh.config.annotation.Lock)")
    @SneakyThrows
