package com.tcyh.common.constant;
...
public enum ErrorCodeEnum {
     ...
     * 两次密码不一致
     */
    USER_PASSWORD_NO_SAME("A0220", "两次密码不一致"),
     ...
     * 用户登录失败
     */
    USER_LOGIN_FAIL("A0211", "用户登录失败"),

    /**
     * 用户注册失败
     */
    USER_REGISTER_FAIL("A0112", "用户注册失败"),

    /**
     * Token刷新失败
     */
    USER_TOKEN_REFRESH_FAIL("A0231", "Token刷新失败"),

    /**
     * 用户登出失败
     */
    USER_LOGOUT_FAIL("A0232", "用户登出失败"),

    /**
     * Token验证失败
     */
    USER_TOKEN_AUTH_FAIL("A0233", "Token验证失败"),

    /**
     * 账户已被锁定，请稍后再试
     */
    USER_LOCK_AUTH_FAIL("A0234", "账户已被锁定，请稍后再试"),

    /**
     * 用户登录失败次数过多，账户已被锁定
     */
    USER_LOGIN_MORE_FAIL("A0235", "登录失败次数过多，账户已被锁定"),

    /**
     * 用户已被禁用
     */
    USER_IS_ENABLE_FAIL("A0236", "用户已被禁用"),
