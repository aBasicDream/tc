...
public class RestResp<T> {
     ...
     * 业务处理失败
     */
    public static <T> RestResp<T> fail(T data, ErrorCodeEnum errorCode) {
        RestResp<T> tRestResp = new RestResp<>(errorCode);
        tRestResp.setData(data);
        return tRestResp;
    }
